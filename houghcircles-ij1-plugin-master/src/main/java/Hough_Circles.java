...
*   must be in black). Input image should go through "8-bit", "Smooth",
*   "Find Edges", "Auto Threshold - method=Default white", and "Size...
*   - width=200 height=129 constrain average interpolation=Bilinear" 
*/
