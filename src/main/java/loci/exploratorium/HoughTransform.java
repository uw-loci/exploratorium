...
public class HoughTransform extends Thread { 
    ...
    public static void main(String[] args) throws Exception { 
    	...
    	String filename = new String("C:/Users/S.S. Mehta/Desktop/fishTail")+args[0]+new String(".png");
        ...
        // get the lines out 
        Vector<HoughLine> lines = h.getLines(150); 
        ...
        try {
            // retrieve image
        	String temp=new String("linesOnMask_");
        	temp=temp+args[0]+new String(".png");
