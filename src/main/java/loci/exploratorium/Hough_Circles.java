 ...
 * <p>
 * Original version by Hemerson Pistori and Eduardo Rocha Costa created on Mar
 * 18 2004, based on Mark A. Schulze applet (http://www.markschulze.net/).
 * </p>
 * <p>
 * New version by Bing Dai created on Aug 25 2016.
 * </p>
 * 
...
public class Hough_Circles implements PlugInFilter {
    ...
    boolean readParameters() {
        ...
        gd.addNumericField("Minimum radius (in pixels) :", 35, 0);
        gd.addNumericField("Maximum radius (in pixels)", 45, 0);
        gd.addNumericField("Increment radius (in pixels) :", 2, 0);
        gd.addNumericField("Number of Circles (NC): (enter 0 if using threshold)", 3, 0);
    ...
    */
	...
	public static void main(String[] args) {
		...
		Class<?> clazz = Hough_Circles.class;
