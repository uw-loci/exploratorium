...
public class adultFish2 implements PlugInFilter {
	...
	public static void main(String[] args) {
		...
		for (int i=1;i<=1;i++)
		{
			...
			Strel strel=Strel.Shape.DISK.fromRadius(10);
			ImageProcessor kip=Morphology.opening(mask1.getProcessor(), strel);
